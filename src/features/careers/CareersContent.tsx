...
const openPositions = [
  ...
  },
  {
    ...
    icon: Shield,
    positions: ["QA Engineer", "Automation Tester", "Security Engineer"],
  },
  {
    ...
    <>
        ...
        <div className="container px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-foreground/80 leading-relaxed max-w-3xl mx-auto">
              Join a team of 75+ passionate engineers and designers building
              cutting-edge solutions for businesses worldwide. Since 2017, we've
              delivered 350+ successful projects.
            </p>
        ...
        <div className="container px-4">
          ...
          >
            ...
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              We're looking for mid-level and senior professionals across these
              departments
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container px-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Why Join Denvora Tech?
            </h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              We invest in our people and create an environment where you can do
              your best work
            </p>
          </motion.div>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-foreground/80">
                Fill out the form below to apply. We'll review your application
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg bg-background border border-border focus:border-blue-500 outline-none transition-colors text-foreground placeholder:text-foreground/60 focus-ring font-medium"
                  />
                </div>
                <div>
                  <label
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-3 rounded-lg bg-background border border-border focus:border-blue-500 outline-none transition-colors text-foreground appearance-none cursor-pointer focus-ring font-medium"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <label
                    htmlFor="cv-upload"
                    className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-lg bg-background border border-border hover:border-blue-500 cursor-pointer transition-colors focus-ring"
                  >
                    <svg
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-3 rounded-lg bg-background border border-border focus:border-blue-500 outline-none transition-colors text-foreground placeholder:text-foreground/60 focus-ring resize-none font-medium"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold text-lg hover:opacity-90 transition-all shadow-lg shadow-blue-600/40 active:scale-[0.98] focus-ring disabled:opacity-50"
              >
