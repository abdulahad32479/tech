  ...
  return (
    <footer className="bg-background border-t border-white/5 pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="container px-4 relative z-10">
            ...
            <form className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input 
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-lg bg-white/5 border border-white/10 focus:border-blue-500 outline-none text-white placeholder:text-muted/40 transition-colors"
                />
              </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted/40">
