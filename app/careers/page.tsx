              ...
              >
                ...
                <ul className="space-y-3">
                  {dept.positions.map((position, pIdx) => (
                    <li key={pIdx} className="flex items-start gap-2 text-muted">
        ...
        <div className="container">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg bg-background border border-border focus:border-blue-500 outline-none transition-colors text-foreground placeholder:text-muted/40"
                  />
                </div>
                <div>
                  <label className="block text-sm font-bold mb-2">
              ...
              <div>
                <label className="block text-sm font-bold mb-2">
                  Key Skills <span className="text-red-500">*</span> <span className="text-muted/60 font-normal">(comma-separated)</span>
                </label>
                <input
                  type="text"
                  name="skills"
              ...
              <div>
                <label className="block text-sm font-bold mb-2">
                  Upload CV <span className="text-muted/60 font-normal">(PDF or Word, max 10MB)</span>
                </label>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-3 rounded-lg bg-background border border-border focus:border-blue-500 outline-none transition-colors text-foreground placeholder:text-muted/40 resize-none"
                />
              </div>
